...
Процедура ПриСозданииНаСервере(Форма, Знач ПараметрыРазмещения = Неопределено) Экспорт
	...
	#Область ил_КОНТАКТНАЯ_ИНФОРМАЦИЯ_И_СОГЛАСОВАННАЯ_СКИДКА
	//--->Начало изменений Ильин М.А.(IL)- 27.08.2024 12:55:49
	//Описание изменений
	//прописываем контактное лицо
	//
	//Добавленный/Измененный код(IL):
	//
	ил_РаботаСФормамиСервер.ДополнитьФормуКонтактнымЛицом(Форма);
	//<---Конец изменений Ильин М.А.(IL) - 27.08.2024 12:57:05
	
	//--->Начало изменений Ильин М.А.(IL)- 27.08.2024 14:12:10
	//Описание изменений
	//добавляем поле Скидки и кнопку обработчик
	//
	//Добавленный/Измененный код(IL):
	//
	ил_РаботаСФормамиСервер.ДополнитьФормуПолемСогласованнаяСкидка(Форма);
	//<---Конец изменений Ильин М.А.(IL) - 27.08.2024 14:13:04
	#КонецОбласти
